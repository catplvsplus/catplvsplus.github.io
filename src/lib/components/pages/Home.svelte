...
<div class="sm:h-1/2 h-3/4 min-h-fit  flex justify-center items-center relative" id="home">
    <div class="w-full max-w-2xl p-5 text-center flex flex-col items-center gap-4">
